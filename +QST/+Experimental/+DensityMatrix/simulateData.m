...
for iTheta = 1:length(theta)
    ...
    PI1D = QST.DensityMatrix.computeProjector1D(quadratures(:,iTheta), theta(iTheta), 14);
    ...
    X(:,iTheta) = QST.DensityMatrix.distributeRandomly(N_X_PER_ANGLE, ...
