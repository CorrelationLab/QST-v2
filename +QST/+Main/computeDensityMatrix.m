function [Rho, Rho_Var] = computeDensityMatrix(X, PiezoSign, Options)
%% Description:
...
%   Rho_Var                            - variance of the averaging process. It has the form of [MaxFockState+1 x MaxFockState+1]
    ...
    while i <= Options.RhosPerAverage*Options.NPiezoSegmentsPerRho
        Rho(:,:,k) = QST.DensityMatrix.performDensityMatrixReconstruction(reshape(X(:,i:i+Options.NPiezoSegmentsPerRho-1),[],1), ...
