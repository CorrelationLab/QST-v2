...
arguments
    ...
    Options.X1String = strcat("X",str(Channel(1))); % Quadrature variablename as String
    Options.X2String = strcat("X",str(Channel(2)));
    Options.X1_IndicesString = ""; % Indices Variablename as String
    Options.X2_IndicesString = "";
    Options.X1_EdgeIndicesString = [strcat("Results_N_G2_TimeResolved.Channel",str(Channel(1)),".EdgeIndices_High"),... % Edgeindices Variablename as String
                                    strcat("Results_N_G2_TimeResolved.Channel",str(Channel(1)),".EdgeIndices")];
    Options.X2_EdgeIndicesString = [strcat("Results_N_G2_TimeResolved.Channel",str(Channel(2)),".EdgeIndices_High"),...
                                    strcat("Results_N_G2_TimeResolved.Channel",str(Channel(2)),".EdgeIndices")];
...
DataFilePaths = QST.File_Managment.getFilePathsFromFolder(RootDirectory,FileTypes="*.mat",IncludeSubFolders=true);
