function [] = analyzeHusimiQFromQuadratures(X1,X2,Resolution,Limits,Options)
...
%% 1.  Calculate the Husimi Q Distribution and analyze its properties
 ...
 HusimiCut,...
 HusimiCut_Theory,...
 radMean] = QST.Plotting.calcHusimiAfterCarolin_2(X1,...
                                                         X2,...
                                                         Resolution,...
                                                         Limits,...
...
QST.Plotting.plotHusimiAfterCarolin(BinsQ,...
                                    BinsP,...
                                    HusimiQ,...
                                    Resolution,...
                                    Options.FitMethod,...
...
QST.Plotting.plotHusimiCutAfterCarolin(BinsQ,...
                                       HusimiCut,...
                                       HusimiCut_Theory,...
                                       poissonErrorsCut,...
                                       Resolution,...
...
if ~isempty(Options.ResultsSaveFile) && ~isempty(Options.ResultsSaveVariableName) % one can improve this function further so it can first check if there is already a Resultstruct or to handle multiple Results in one struct
    ...
    eval([Options.ResultsSaveVariableName '= SaveStruct;']);
