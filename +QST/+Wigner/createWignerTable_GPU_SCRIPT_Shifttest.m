...
Dir = 'D:\Programming\Wignertables\Start_m5__Step0i015625__End_5__maxFock_75_ShiftedP3';
...
Q = gpuArray([-maxQ+ShiftQ:stepsizeQ:maxQ+ShiftQ]);
Zeta = gpuArray([-maxZeta+ShiftQ:stepsizeZeta:maxZeta+ShiftQ]);
nQ = length(Q);
nZeta = length(Zeta);
...
P = gpuArray([-maxQ+ShiftP:stepsizeQ:maxQ+ShiftP]);
nP = nQ;
