function [Identifier,nTherm,nThermErr,nCoherent,nCoherentErr,nMean,Coherence,CoherenceErr,nRatio,g2] = collectSeriesResult_HusimiQ(DirPath, Identifier, Options)
    arguments
        DirPath;
        Identifier;
