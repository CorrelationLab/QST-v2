function [IdentifierSeries,N_1_Mean,N_2_Mean,N_Mean,N_1_Std,N_2_Std,N_Std,G2_1_Mean,G2_2_Mean,G2_Mean,G2_1_Std,G2_2_Std,G2_Std] = collectSeriesResult_N_G2(DirPath, Identifier, Options)
    arguments
        DirPath;
        Identifier;
